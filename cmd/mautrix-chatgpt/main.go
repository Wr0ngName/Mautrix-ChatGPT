// mautrix-chatgpt is a Matrix-ChatGPT API puppeting bridge.
package main

import (
	"go.mau.fi/mautrix-chatgpt/pkg/connector"
...
func main() {
	...
	m = mxmain.BridgeMain{
		Name:        "mautrix-chatgpt",
		URL:         "https://github.com/mautrix/chatgpt",
		Description: "A Matrix-ChatGPT API bridge",
		Version:     "0.1.0",
		Connector:   c,
		PostInit:    postInit,
	}
